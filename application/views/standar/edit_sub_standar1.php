...
<?php echo form_open('standar/edit_sub_standar1/'.$query['id'].'/'.$query['no_standar'].'/'.$query['no_substandar']); ?>
<div class="container">
  ...
  <div class="panel-body">
    <table class="table table-striped">
        <tr>
            ...
            <td><input type="input" name="no_substandar" id="no_substandar" size="50" value="<?php echo $query['no_substandar_1'] ?>" /></td>
            <td><span id="cek_hasil"></span></td>
        </tr>
        <tr>
            <td><label for="text">Nama Sub standar</label></td>
            <td><textarea name="nama_substandar" rows="10" cols="40"><?php echo $query['nama_substandar_1'] ?></textarea></td>
        </tr>
        <tr>
            <td></td>
            <td><input type="submit" name="submit" id="submit" value="Edit Sub Standar 2" /></td>
        </tr>
    </table>
...
<script>  
 $(document).ready(function(){
      $('#no_substandar').change(function(){  
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url(); ?>standar/cek_edit_nomor_substandar1/"+no_standar+"/"+no_sub_standar,  
                     method:"POST",  
